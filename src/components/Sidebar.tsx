...
import { HomeIcon, SparklesIcon, ChatBubbleOvalLeftEllipsisIcon, UserCircleIcon, Cog6ToothIcon } from '@heroicons/react/24/outline';
import { HomeIcon as HomeSolidIcon, SparklesIcon as SparklesSolidIcon, ChatBubbleOvalLeftEllipsisIcon as ChatSolidIcon, UserCircleIcon as UserSolidIcon, Cog6ToothIcon as CogSolidIcon } from '@heroicons/react/24/solid';
            ...
            <nav>
                <ul className="space-y-2">
                   ...
                   <NavItem 
                        label="Profile" 
                        view="profile"
                        isActive={currentView === 'profile' && !location.pathname.includes('/pet/')}
                        Icon={UserCircleIcon}
