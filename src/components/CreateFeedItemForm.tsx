...
import { PhotoIcon, SparklesIcon, CalendarIcon, TagIcon, PencilSquareIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <div className="flex border-b border-gray-200 dark:border-gray-700">
        <TabButton tabName="post" label="New Post" icon={<ChatBubbleLeftRightIcon className="h-5 w-5"/>} />
