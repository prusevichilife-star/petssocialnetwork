...
import { SparklesIcon, UserGroupIcon, GlobeAltIcon, ChatBubbleBottomCenterTextIcon } from '@heroicons/react/24/solid';
...
const FilterButton: React.FC<{
    ...
    const baseClasses = "flex-1 sm:flex-none flex items-center justify-center sm:justify-start px-4 py-2 text-sm font-semibold rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800";
